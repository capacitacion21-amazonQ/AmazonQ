...
Sistema calcula posición (#5) y tiempo estimado (25 min)
Sistema muestra confirmación en pantalla
Sistema envía Mensaje 1 de confirmación vía Telegram
3.2 Notificación de Progreso
Cliente puede salir de sucursal
Sistema monitorea progreso de cola automáticamente
Cuando posición ≤ 3, sistema envía Mensaje 2 (pre-aviso)
Cliente regresa a sucursal
3.3 Asignación y Atención
Sistema detecta ejecutivo disponible
Sistema asigna ticket al ejecutivo óptimo (balanceo de carga)
Sistema envía Mensaje 3 con módulo y nombre del asesor
Sistema notifica al ejecutivo en su terminal
Sistema actualiza pantallas de sucursal
Cliente se presenta en módulo indicado
Ejecutivo atiende al cliente
Sistema marca ticket como completado
Sistema libera ejecutivo para siguiente asignación
3.4 Supervisión
